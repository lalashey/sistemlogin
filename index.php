...
<div class="header">
  ...
  <center>  <table style="margin-left:auto;margin-right:auto"  border="1" cellpadding="10" cellspacing="0">
        <tr>
            <th>No.</th>
            <th>Aksi</th>
            <th>Photo</th>
        ...
        <?php foreach ($mahasiswa as $row) : ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="hapus.php?id=<?php echo $row["id"] ?>" onclick="return confirm('Yakin mau dihapus? NTAR NYESEL LOHHHHH');  ">Hapus</a>
                </td>
